package crc642044eea4c3980544;


public class SliderPictureAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("SlidePicture.SliderPictureAdapter, SlidePicture", SliderPictureAdapter.class, __md_methods);
	}


	public SliderPictureAdapter ()
	{
		super ();
		if (getClass () == SliderPictureAdapter.class)
			mono.android.TypeManager.Activate ("SlidePicture.SliderPictureAdapter, SlidePicture", "", this, new java.lang.Object[] {  });
	}
